 ...
 * <code>com.sun.jdi.ClassPrepareRequest.addClassFilter_rt()</code>     <BR>
 ...
 * - The debuggee creates a class filter object, to load the Class to   <BR>
 *   filter, and invokes the methodForCommunication to be suspended and <BR>
            ...
            switch (i) {
              ...
              case 0:
                     ...
                     try {
                         ...
                         ((ClassPrepareRequest)eventRequest1).addClassFilter(testClassReference);
