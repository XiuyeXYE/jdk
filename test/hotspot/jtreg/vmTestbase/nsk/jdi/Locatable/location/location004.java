 ...
 * complies with its spec when applied to a static method.      <BR>
 * <BR>
...
public class location004 {
    ...
    public static int run (String argv[], PrintStream out) {
        return new location004().runThis(argv, out);
    }
    ...
    private String testedClassName =
        "nsk.jdi.Locatable.location.Threadlocation004a";
