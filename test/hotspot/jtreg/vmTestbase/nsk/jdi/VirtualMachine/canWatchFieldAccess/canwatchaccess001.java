...
package nsk.jdi.VirtualMachine.canWatchFieldAccess;
 ...
 * <code>com.sun.jdi.VirtualMachine.canWatchFieldAccess()</code><BR>
...
public class canwatchaccess001 extends JDIBase {
    ...
    public static int run (String argv[], PrintStream out) {
        ...
        int exitCode = new canwatchaccess001().runThis(argv, out);
