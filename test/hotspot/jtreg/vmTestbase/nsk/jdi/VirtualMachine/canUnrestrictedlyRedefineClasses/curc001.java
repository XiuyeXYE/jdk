...
package nsk.jdi.VirtualMachine.canUnrestrictedlyRedefineClasses;
 ...
 * <code>com.sun.jdi.VirtualMachine.canUnrestrictedlyRedefineClasses()</code> <BR>
...
public class curc001 extends JDIBase {
    ...
    public static int run (String argv[], PrintStream out) {
        ...
        int exitCode = new curc001().runThis(argv, out);
    ...
    */
    ...
    //------------------------------------------------------  testing section
        ...
        for (int i = 0; ; i++) {
            ...
            log2("...... vm.canUnrestrictedlyRedefineClasses()");
            if ( vm.canUnrestrictedlyRedefineClasses() )
                log2("      vm.canUnrestrictedlyRedefineClasses() == true");
            else
                log2("      vm.canUnrestrictedlyRedefineClasses() == false");
