 ...
 * <code>com.sun.jdi.VirtualMachine.canWatchFieldModification()</code>  <BR>
...
public class canwatchmod001 extends JDIBase {
    ...
    public static int run (String argv[], PrintStream out) {
        ...
        int exitCode = new canwatchmod001().runThis(argv, out);
    ...
    */
    ...
    //------------------------------------------------------  testing section
        ...
        for (int i = 0; ; i++) {
            ...
            log2("...... vm.canWatchFieldModification()");
