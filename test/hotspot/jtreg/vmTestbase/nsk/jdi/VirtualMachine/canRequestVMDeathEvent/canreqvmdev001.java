...
package nsk.jdi.VirtualMachine.canRequestVMDeathEvent;
 ...
 * <code>com.sun.jdi.VirtualMachine.canRequestVMDeathEvent()</code> <BR>
...
public class canreqvmdev001 extends JDIBase {
    ...
    public static int run (String argv[], PrintStream out) {
        ...
        int exitCode = new canreqvmdev001().runThis(argv, out);
    ...
    */
    ...
    //------------------------------------------------------  testing section
        ...
        for (int i = 0; ; i++) {
            ...
            log2("...... canRequestVMDeathEvent()");
            if ( vm.canRequestVMDeathEvent() )
                log2("      vm.canRequestVMDeathEvent() == true");
            else
                log2("      vm.canRequestVMDeathEvent() == false");
