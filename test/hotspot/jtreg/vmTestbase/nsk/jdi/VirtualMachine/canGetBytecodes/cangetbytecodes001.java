 ...
 * <code>com.sun.jdi.VirtualMachine.canGetBytecodes()</code>            <BR>
 ...
 * - gets the Method mtd object                                         <BR>
 *   mirroring the method "testedMethod" in the debuggee,               <BR>
 * - calls to the method VirtualMachine.canGetBytecodes()               <BR>
 *   to get its returned value.                                         <BR>
 * Then if the value is true the debugger checks up that invoking       <BR>
 * the method Method.bytecodes() on the mtd doesn't throw               <BR>
 *    UnsupportedOperationException.                                    <BR>
 * If the value is false the debugger checks up that invoking           <BR>
 * the method Method.bytecodes() on the mtd does throw                  <BR>
 *    UnsupportedOperationException.                                    <BR>
 */

public class cangetbytecodes001 {
    ...
    public static int run (String argv[], PrintStream out) {
        return new cangetbytecodes001().runThis(argv, out);
    }
    ...
    //String mName = "nsk.jdi.VirtualMachine.canGetBytecodes";
