 ...
 * <code>com.sun.jdi.VirtualMachine.canPopFrames()</code>       <BR>
...
public class canpopframes001 extends JDIBase {
    ...
    public static int run (String argv[], PrintStream out) {
        ...
        int exitCode = new canpopframes001().runThis(argv, out);
    ...
    */
    ...
    //------------------------------------------------------  testing section
        ...
        for (int i = 0; ; i++) {
            ...
            if ( vm.canPopFrames() )
                log2("      vm.canPopFrames() == true");
            else
                log2("      vm.canPopFrames() == false");
