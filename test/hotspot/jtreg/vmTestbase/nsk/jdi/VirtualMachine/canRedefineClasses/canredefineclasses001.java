 ...
 * <code>com.sun.jdi.VirtualMachine.canRedefineClasses()</code> <BR>
...
public class canredefineclasses001 extends JDIBase {
    ...
    public static int run (String argv[], PrintStream out) {
        ...
        int exitCode = new canredefineclasses001().runThis(argv, out);
    ...
    */
    ...
    //------------------------------------------------------  testing section
        ...
        for (int i = 0; ; i++) {
            ...
            log2("...... vm.canRedefineClasses()");
            if ( vm.canRedefineClasses() )
                log2("      vm.canRedefineClasses() == true");
            else
                log2("      vm.canRedefineClasses() == false");
