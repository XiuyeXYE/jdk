 ...
 * complies with its spec when ObjectReference is ThreadGroupReference.<BR>
 * <BR>
...
public class referencetype003 {
    ...
    public static int run (String argv[], PrintStream out) {
        return new referencetype003().runThis(argv, out);
    }
    ...
    private String testedClassName = "java.lang.ThreadGroup";
            ...
            ReferenceType     mainThreadClass  = null;
             ...
             label0: {
                ...
                if (!testedClass1.equals(testedClass)) {
                    ...
                    log3("ERROR: ReferenceType testedClass is of the type : " + testedClass);
                    log3("ERROR: performing statement: !mainThreadGroup.referenceType().equals(testedClass)");
