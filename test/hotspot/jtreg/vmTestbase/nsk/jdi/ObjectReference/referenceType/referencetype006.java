...
public class referencetype006 {
    ...
    public static int run (String argv[], PrintStream out) {
        return new referencetype006().runThis(argv, out);
    }
    ...
    private String testedClassName =
        "nsk.jdi.ObjectReference.referenceType.referencetype006aInterfaceForCheck[]";
    ...
    //------------------------------------------------------  testing section
        ...
        for (int i = 0; ; i++) {
            ...
            List listOftestedClasses = vm.classesByName(mName + ".referencetype006aTestClass");
