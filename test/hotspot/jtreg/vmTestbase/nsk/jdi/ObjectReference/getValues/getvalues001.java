 ...
 *      class getvalues001aTestClass extends getvalues001aTestClass1                    <BR>
...
public class getvalues001 {
    ...
    private String testedClassName =
        "nsk.jdi.ObjectReference.getValues.getvalues001aTestClass";
    ...
    //------------------------------------------------------  testing section
        ...
        for (int i = 0; ; i++) {
            ...
            Field [] fArray = {
                ...
                testedClass.fieldByName(names[ 4]), testedClass.fieldByName(names[ 5]),
                testedClass.fieldByName(names[ 6]), testedClass.fieldByName(names[ 7]),
                testedClass.fieldByName(names[ 8]), testedClass.fieldByName(names[ 9]),
            ...
            for (int ifor = 0; si.hasNext(); ifor++) {
                ...
                int flag1 = 0;
                for (int ifor1 = 0; ifor1 < 16; ifor1++) {
