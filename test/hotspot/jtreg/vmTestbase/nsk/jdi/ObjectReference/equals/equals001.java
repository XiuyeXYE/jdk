 ...
 * <code>com.sun.jdi.ObjectReference.equals()</code>            <BR>
 ...
 * - objRef1.equals(objRef2) returns true and                   <BR>
 * - objRef1.equals(objRef3) returns false.                     <BR>
 */
...
public class equals001 {
    ...
    //String mName = "nsk.jdi.ObjectReference.equals";
    ...
    //------------------------------------------------------  testing section
        ...
        for (int i = 0; ; i++) {
            ...
            if (!objRef1.equals(objRef2)) {
                log3("ERROR: objRef1 is not equal to objRef2");
                testExitCode = FAILED;
            }

            log2("......testing inequality of objRef1 and objRef3");
            if (objRef1.equals(objRef3)) {
                log3("ERROR: objRef1 is equal to objRef3");
                testExitCode = FAILED;
            }
