...
public class invokemethod001 {
    ...
    private String testedClassName =
        "nsk.jdi.ObjectReference.invokeMethod.Threadinvokemethod001a";

    //String mName = "nsk.jdi.ObjectReference.invokeMethod";
            ...
            label1: {
                ...
                label: {
                    for (int i3 = 0; i3 <= 8; i3++) {
                         ...
                         List argumentList = invokeMethods;
                         argumentList.clear();

                         try {
                             returnValue =
                                 threadObjRef.invokeMethod(thread2,
