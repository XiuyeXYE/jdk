 ...
 * <code>com.sun.jdi.ThreadReference.frame()</code>             <BR>
 ...
 *     in stack order;                                                  <BR>
 * (2) checks up that invoking ThreadReference.frame()                  <BR>
 *     doesn't throw 'IncompatibleThreadStateException' when            <BR>
 *     thread2 is suspended, and does throw otherwize;                  <BR>
 * (3) forces first thread to leave the synchronized block              <BR>
 ...
 *   only invoking methods  thread2.frame(0) and                        <BR>
 *                          thread2.frame(1)                            <BR>
 *   doesn't throw IndexOutOfBoundsException;                           <BR>
 * - when the thread2 is suspended at first breakpoint within 'runt2',  <BR>
 *   only invoking methods  thread2.frame(0),                           <BR>
 *                          thread2.frame(1), and                       <BR>
 *                          thread2.frame(2)                            <BR>
 *   doesn't throw IndexOutOfBoundsException;                           <BR>
 ...
 *   only invoking methods  thread2.frame(0) and                        <BR>
 *                          thread2.frame(1)                            <BR>
 * whereas invoking the method with negative or larger number           <BR>
 * does throw IndexOutOfBoundsException.                                <BR>
 * <BR>
 */

public class frame001 {
    ...
    public static int run (String argv[], PrintStream out) {
        return new frame001().runThis(argv, out);
    }
    ...
    private String testedClassName =
        "nsk.jdi.ThreadReference.frame.Threadframe001a";

    //String mName = "nsk.jdi.ThreadReference.frame";
    ...
    //------------------------------------------------------  testing section
        ...
        for (int i = 0; ; i++) {
            ...
            label1: {
                ...
                log2("       the check that 'thread2.frameCount()' does throw exception");
                ...
                for (int i3 = 0; i3 < 3; i3++) {
                    ...
                    try {
                        stackFrame = thread2.frame(-1);
                        log3 ("ERROR: no IndexOutOfBoundsException for: thread2.frame(-1)");
                        expresult = returnCode1;
                    } catch ( IndexOutOfBoundsException e1 ) {
                        log2("     : IndexOutOfBoundsException for: thread2.frame(-1)");
                    } catch ( IncompatibleThreadStateException e2 ) {
                        log3("ERROR: IncompatibleThreadStateException for thread2.frame(-1)");
                        expresult = returnCode1;
                    } catch ( ObjectCollectedException e3 ) {
                        log3("ERROR: ObjectCollectedException for thread2.frame(-1)");
                        expresult = returnCode1;
                    }

                    log2("       checking up that thread2.frame(index) does throw exception");
                    log2("           when index is equal to frameCount()");

                    try {
                        iCount = thread2.frameCount();
                        stackFrame = thread2.frame(iCount);
                        log3 ("ERROR: no IndexOutOfBoundsException for: thread2.frame(iCount) : " + iCount);
                        expresult = returnCode1;
                    } catch ( IndexOutOfBoundsException e1 ) {
                        log2("     : IndexOutOfBoundsException for: thread2.frame(iCount) : " + iCount);
                    } catch ( IncompatibleThreadStateException e2 ) {
                        log3("ERROR: IncompatibleThreadStateException for thread2.frameCount()");
                        expresult = returnCode1;
                    } catch ( ObjectCollectedException e3 ) {
                        log3("ERROR: ObjectCollectedException for thread2.frameCount()");
                        expresult = returnCode1;
                    }

                    log2("       checking up that thread2.frame(index) does throw exception");
                    log2("           when index is greater than frameCount()");

                    try {
                        iCount = thread2.frameCount();
                        stackFrame = thread2.frame(iCount + 1);
                        log3 ("ERROR: no IndexOutOfBoundsException for: thread2.frame(iCount + 1) : " +
                                      (thread2.frameCount() +1) );
                        expresult = returnCode1;
                    } catch ( IndexOutOfBoundsException e1 ) {
                        log2("     : IndexOutOfBoundsException for: thread2.frame(iCount + 1) : " +
                                      (iCount + 1) );
                    } catch ( IncompatibleThreadStateException e2 ) {
                        log3("ERROR: IncompatibleThreadStateException for thread2.frameCount()");
                        expresult = returnCode1;
                    ...
                    try {
                        ...
                        log2("     : no Exception for:  stackFrame = thread2.frame(0)");
                    } catch ( IndexOutOfBoundsException e1 ) {
                        log3("ERROR: IndexOutOfBoundsException for: thread2.frame(0)");
                        expresult = returnCode1;
                    } catch ( IncompatibleThreadStateException e2 ) {
                        log3("ERROR: wrong IncompatibleThreadStateException for thread2.frame(0)");
                        expresult = returnCode1;
                    } catch ( ObjectCollectedException e3 ) {
                    ...
                    switch (i3) {
                      ...
                      case 0: log2("     first breakpoint in 'runt1'");

                              log2("       checking up that thread2.frame(1) doesn't throw exception");
                              try {
                                  stackFrame1 = thread2.frame(1);
                                  log2("     : no exception for: stackFrame1 = thread2.frame(1)");
                              } catch ( IndexOutOfBoundsException e1 ) {
                                  log3("ERROR: IndexOutOfBoundsException for case 0:");
                                  expresult = returnCode1;
                              } catch ( IncompatibleThreadStateException e2 ) {
                                  log3("ERROR: IncompatibleThreadStateException for case 0:");
                                  expresult = returnCode1;
                              } catch ( ObjectCollectedException e3 ) {
                                  log3("ERROR: ObjectCollectedException for case 0:");
                                  expresult = returnCode1;
                              }
                              if (expresult == returnCode0) {
                      ...
                      case 1: log2("     first breakpoint in 'runt2'");

                              log2("       checking up that thread2.frame(1) and ");
                              log2("           that thread2.frame(2) don't throw exceptions");
                              try {
                                  stackFrame1 = thread2.frame(1);
                                  log2("     : no exception for: stackFrame1 = thread2.frame(1)");
                                  stackFrame2 = thread2.frame(2);
                                  log2("     : no exception for: stackFrame2 = thread2.frame(2)");
                              } catch ( IndexOutOfBoundsException e1 ) {
                                  log3("ERROR: IndexOutOfBoundsException for case 1:");
                                  expresult = returnCode1;
                              } catch ( IncompatibleThreadStateException e2 ) {
                                  log3("ERROR: IncompatibleThreadStateException for case 1:");
                                  expresult = returnCode1;
                              } catch ( ObjectCollectedException e3 ) {
                                  log3("ERROR: ObjectCollectedException for case 1:");
                                  expresult = returnCode1;
                              }
                              if (expresult == returnCode0) {
                      ...
                      case 2: log2("     second breakpoint in 'runt1'");
                              ...
                              try {
                                  ...
                                  log3("ERROR: IndexOutOfBoundsException for case 2:");
                                  expresult = returnCode1;
                              } catch ( IncompatibleThreadStateException e2 ) {
                                  log3("ERROR: IncompatibleThreadStateException for case 2:");
                                  expresult = returnCode1;
                              } catch ( ObjectCollectedException e3 ) {
                                  log3("ERROR: ObjectCollectedException for case 2:");
                                  expresult = returnCode1;
                              }
                              break;
                    }
