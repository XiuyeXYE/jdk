 ...
 * <code>com.sun.jdi.ThreadReference.isAtBreakpoint()</code>    <BR>
 ...
 * - checks up the values returned by the method isAtBreakpoint();      <BR>
 * - sets up a breakpoint within the 'runt1' method to be called.       <BR>
 * - forces main thread to leave the synchronized block                 <BR>
 *     in order to unlock the thread2.                                  <BR>
 * When the thread2 is suspended at the breakpoint,                     <BR>
 * the debugger checks up the value returned by thread2.isAtBreakpoint()<BR>
 * two times, before to resume the thread2 and after that.              <BR>
 * <BR>
 */

public class isatbreakpoint001 {
    ...
    public static int run (String argv[], PrintStream out) {
        return new isatbreakpoint001().runThis(argv, out);
    }
    ...
    private String testedClassName =
        "nsk.jdi.ThreadReference.isAtBreakpoint.Threadisatbreakpoint001a";

    //String mName = "nsk.jdi.ThreadReference.isAtBreakpoint";
    ...
    //------------------------------------------------------  testing section
        ...
        for (int i = 0; ; i++) {
            ...
            label1: {
                ...
                // checking up for Code4 here is to allow further checks that impossible otherwise
