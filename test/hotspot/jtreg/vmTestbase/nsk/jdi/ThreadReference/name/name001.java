 ...
 * <code>com.sun.jdi.ThreadReference.name()</code>              <BR>
 ...
 * the debugger checks up that the string returned by thread2.name()    <BR>
 * is equal to one used to create it.                                   <BR>
 * <BR>
 */
...
public class name001 {
    ...
    private String testedClassName =
        "nsk.jdi.ThreadReference.name.Threadname001a";

    //String mName = "nsk.jdi.ThreadReference.name";
    ...
    //------------------------------------------------------  testing section
        ...
        for (int i = 0; ; i++) {
            ...
            label1: {
                ...
                log2("      checking up thread2's name; expected: 'testedThread'");
                String name = thread2.name();
                if (!name.equals(threadName)) {
                    log3("ERROR: !name.equals(threadName) :" + name);
                    expresult = returnCode1;
                }
