 ...
 * <code>com.sun.jdi.ExceptionRequest.notifyCaught()</code>     <BR>
 ...
 *    ExceptionRequest.notifyCaught()                                   <BR>
 ...
 *     the notifyCaught argument,                                       <BR>
 *   - gets the values of the Request with the method                   <BR>
 *     StepRequest.notifyCaught(), and                                  <BR>
...
public class notifycaught001 extends JDIBase {
    ...
    public static int run (String argv[], PrintStream out) {
        ...
        int exitCode = new notifycaught001().runThis(argv, out);
        ...
        for (int i = 0; ; i++) {
            ...
            switch (i) {
              ...
              case 0:
                     ...
                     log2("......getting: bool = ((ExceptionRequest) eventRequest1).notifyCaught();");
                     bool = ((ExceptionRequest) eventRequest1).notifyCaught();
                     ...
                     log2("......setting up: eventRequest2 = setting24ExceptionRequest(false,  true);");
                     eventRequest2 = setting24ExceptionRequest(false,  true);

                     log2("......getting: bool = ((ExceptionRequest) eventRequest2).notifyCaught();");
                     bool = ((ExceptionRequest) eventRequest2).notifyCaught();
