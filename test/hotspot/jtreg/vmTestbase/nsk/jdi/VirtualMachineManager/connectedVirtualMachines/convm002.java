 ...
 * - after the degugger terminates the debuggee with the method <BR>
 *   VirtualMachine.exit(),                                     <BR>
 *   the call to the method returns an empty List.              <BR>
 */

public class convm002 {
    ...
    public static int run(String argv[], PrintStream out) {
        return new convm002().runThis(argv, out);
    }
    ...
    private String debuggeeName = "nsk.jdi.VirtualMachineManager.connectedVirtualMachines.convm002a";
    ...
    private int runThis(String argv[], PrintStream out) {
        ...
        List<VirtualMachine> connectedVM;
        ...
        log2("......vm1.exit(" + (PASSED + PASS_BASE) + ")");
        vm1.exit(PASSED + PASS_BASE);
                ...
                for (; eIter.hasNext();) {
                    ...
                    ll: for (int ifor = 0;; ifor++) {
                        ...
                        try {
                            ...
                            case 0:
                                AccessWatchpointEvent awe = (AccessWatchpointEvent) ev;
                            ...
                            case 2:
                                ...
                                break ll;
                            case 3:
                                ClassUnloadEvent cue = (ClassUnloadEvent) ev;
                            ...
                            case 4:
                                ...
                                break ll;
                            case 5:
                                MethodEntryEvent mene = (MethodEntryEvent) ev;
                                log2("      MethodEntryEvent removed");
                                break ll;
                            case 6:
                                MethodExitEvent mexe = (MethodExitEvent) ev;
                                log2("      MethodExiEvent removed");
                                break ll;
                            case 7:
                                ModificationWatchpointEvent mwe = (ModificationWatchpointEvent) ev;
                            ...
                            case 8:
                                ...
                                break ll;
                            case 9:
                                ThreadDeathEvent tde = (ThreadDeathEvent) ev;
                                log2("      ThreadDeathEvent removed");
                                break ll;
                            case 10:
                                ThreadStartEvent tse = (ThreadStartEvent) ev;
                                log2("      ThreadStartEvent removed");
                                break ll;
                            case 11:
                                VMDeathEvent vmde = (VMDeathEvent) ev;
                                log2("      VMDeathEvent removed");
                                break ll;
                            case 12:
                                VMStartEvent vmse = (VMStartEvent) ev;
                                log2("      VMStartEvent removed");
                                break ll;
                            case 13:
                                WatchpointEvent we = (WatchpointEvent) ev;
                                log2("      WatchpointEvent removed");
                                break ll;

                            case 14:
                                VMDisconnectEvent wmde = (VMDisconnectEvent) ev;
                                log2("      VMDisconnectEvent removed");
                                break labelBP;

                            default:
                                log3("ERROR:  default case for casting event");
                                returnCode = returnCode3;
                                break ll;
                            } // switch
