...
public class threadfilter003 extends JDIBase {
    ...
    private String testedClassName =
      "nsk.jdi.MethodEntryRequest.addThreadFilter.threadfilter003aTestClass";
    ...
    */
    ...
    //------------------------------------------------------  testing section
        ...
        String property3 = "MethodEntryRequest3";
        ...
        for (int i = 0; ; i++) {
            ...
            switch (i) {
              ...
              case 1:
                     eventRequest2 = setting2MethodEntryRequest (null,
                                             testClassReference,
                                             EventRequest.SUSPEND_NONE, property2);
                     try {
                         log2("......eventRequest2.addThreadFilter(thread1);");
                         log2("        no Exception expected");
                         ((MethodEntryRequest)eventRequest2).addThreadFilter(thread1);
                     } catch ( Exception e ) {
                         log3("ERROR: Exception : " + e);
                         testExitCode = FAILED;
                     }
              ...
              case 2:
                     eventRequest3 = setting2MethodEntryRequest (null,
                                             testClassReference,
                                             EventRequest.SUSPEND_NONE, property3);
                     try {
                         log2("......eventRequest3.addThreadFilter(thread1);");
                         log2("        no Exception expected");
                         ((MethodEntryRequest)eventRequest3).addThreadFilter(thread1);
                     } catch ( Exception e ) {
                         log3("ERROR: Exception : " + e);
                         testExitCode = FAILED;
                     }
