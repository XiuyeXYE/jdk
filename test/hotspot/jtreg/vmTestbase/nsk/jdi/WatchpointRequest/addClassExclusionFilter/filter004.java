 ...
 * <code>com.sun.jdi.WatchpointRequest.addClassExclusionFilter()</code> <BR>
 ...
 * The cases to test include ModificationWatchpointRequest.             <BR>
 * <BR>
...
public class filter004 extends JDIBase {
    ...
    public static int run (String argv[], PrintStream out) {
        ...
        int exitCode = new filter004().runThis(argv, out);
    ...
    private String testedClassName1 =
      "nsk.jdi.WatchpointRequest.addClassExclusionFilter.filter004aTestClass10";
    ...
    */
    ...
    private ModificationWatchpointRequest setting23ModificationWatchpointRequest (
        ...
        try {
            ...
            awr.addClassExclusionFilter(testedClass);
