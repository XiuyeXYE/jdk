...
public class filter_s004 extends JDIBase {
    ...
    public static int run (String argv[], PrintStream out) {
        ...
        int exitCode = new filter_s004().runThis(argv, out);
    ...
    private String testedClassName1 =
      "nsk.jdi.WatchpointRequest.addClassFilter_s.filter_s004aTestClass10";
