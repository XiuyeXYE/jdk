 ...
 * The tested Request is ModificationWatchpointRequest.         <BR>
 * <BR>
 ...
 *   - creates ModificationWatchpointRequest1 and                       <BR>
 *     invokes the method addThreadFilter(tread1) on the request1,      <BR>
 *   - creates ModificationWatchpointRequest2,                          <BR>
 *     resumes the debuggee to get the thread1 started, and             <BR>
 *     invokes the method addThreadFilter(thread) on the request2,      <BR>
 *   - creates ModificationWatchpointRequest3, waits the thread1 to die,<BR>
 *     and invokes the method addThreadFilter(thread) on the request3.  <BR>
 * <BR>
...
public class addthreadfilter006 extends JDIBase {
    ...
    public static int run (String argv[], PrintStream out) {
        ...
        int exitCode = new addthreadfilter006().runThis(argv, out);
    ...
    private String testedClassName =
      "nsk.jdi.WatchpointRequest.addThreadFilter.addthreadfilter006aTestClass";
    ...
    */
    ...
    //------------------------------------------------------  testing section
        ...
        String property3 = "ModificationWatchpointRequest3";
        ...
        for (int i = 0; ; i++) {
            ...
            switch (i) {
              ...
              case 1:
                      eventRequest2 = setting2ModificationWatchpointRequest (null,
                                             testClassReference, fieldName,
                                             EventRequest.SUSPEND_NONE, "ModificationWatchpointRequest2");
                      try {
                          log2("......eventRequest2.addThreadFilter(thread1);");
                          log2("        no Exception expected");
                          ((ModificationWatchpointRequest)eventRequest2).addThreadFilter(thread1);
                      } catch ( Exception e ) {
                          log3("ERROR: Exception : " + e);
                          testExitCode = FAILED;
                      }
              ...
              case 2:
                      eventRequest3 = setting2ModificationWatchpointRequest (null,
                                             testClassReference, fieldName,
                                             EventRequest.SUSPEND_NONE, "ModificationWatchpointRequest3");
                      try {
                          log2("......eventRequest3.addThreadFilter(thread1);");
                          log2("        no Exception expected");
                          ((ModificationWatchpointRequest)eventRequest3).addThreadFilter(thread1);
                      } catch ( Exception e ) {
                          log3("ERROR: Exception : " + e);
                          testExitCode = FAILED;
                      }
