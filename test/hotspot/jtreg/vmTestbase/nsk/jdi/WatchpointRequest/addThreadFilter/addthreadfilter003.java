 ...
 * The test case includes AccessWatchpointRequest.              <BR>
 * <BR>
...
public class addthreadfilter003 extends JDIBase {
    ...
    private String testedClassName =
      "nsk.jdi.WatchpointRequest.addThreadFilter.addthreadfilter003aTestClass";
        ...
        for (int i = 0; ; i++) {
            ...
            switch (i) {
              ...
              case 0:
                      ...
                      eventRequest1 = setting2AccessWatchpointRequest (null,
                                             testClassReference, fieldName,
                                             EventRequest.SUSPEND_NONE, "AccessWatchpointRequest1");
