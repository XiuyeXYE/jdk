 ...
 * <code>com.sun.jdi.WatchpointRequest.addThreadFilter()</code> <BR>
 ...
 * The test case includes ModificationWatchpointRequest.        <BR>
 * <BR>
 ...
 *   - creates an ModificationWatchpointRequest and enables it,         <BR>
...
public class addthreadfilter004 extends JDIBase {
    ...
    public static int run (String argv[], PrintStream out) {
        ...
        int exitCode = new addthreadfilter004().runThis(argv, out);
    ...
    private String testedClassName =
      "nsk.jdi.WatchpointRequest.addThreadFilter.addthreadfilter004aTestClass";
        ...
        for (int i = 0; ; i++) {
            ...
            switch (i) {
              ...
              case 0:
                      ...
                      eventRequest1 = setting2ModificationWatchpointRequest (null,
                                             testClassReference, fieldName,
                                             EventRequest.SUSPEND_NONE, "ModificationWatchpointRequest1");
