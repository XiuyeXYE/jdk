 ...
 * The tested Request is AccessWatchpointRequest.               <BR>
 * <BR>
...
public class addthreadfilter005 extends JDIBase {
    ...
    public static int run (String argv[], PrintStream out) {
        ...
        int exitCode = new addthreadfilter005().runThis(argv, out);
    ...
    private String testedClassName =
      "nsk.jdi.WatchpointRequest.addThreadFilter.addthreadfilter005aTestClass";
    ...
    */
    ...
    //------------------------------------------------------  testing section
        ...
        String property3 = "AccessWatchpointRequest3";
        ...
        for (int i = 0; ; i++) {
            ...
            switch (i) {
              ...
              case 1:
                      eventRequest2 = setting2AccessWatchpointRequest (null,
                                             testClassReference, fieldName,
                                             EventRequest.SUSPEND_NONE, "AccessWatchpointRequest2");
                      try {
                          log2("......eventRequest2.addThreadFilter(thread1);");
                          log2("        no Exception expected");
                          ((AccessWatchpointRequest)eventRequest2).addThreadFilter(thread1);
                      } catch ( Exception e ) {
                          log3("ERROR: Exception : " + e);
                          testExitCode = FAILED;
                      }
              ...
              case 2:
                      eventRequest3 = setting2AccessWatchpointRequest (null,
                                             testClassReference, fieldName,
                                             EventRequest.SUSPEND_NONE, "AccessWatchpointRequest3");
                      try {
                          log2("......eventRequest3.addThreadFilter(thread1);");
                          log2("        no Exception expected");
                          ((AccessWatchpointRequest)eventRequest3).addThreadFilter(thread1);
                      } catch ( Exception e ) {
                          log3("ERROR: Exception : " + e);
                          testExitCode = FAILED;
                      }
