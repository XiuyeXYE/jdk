...
public class filter_rt004 extends JDIBase {
    ...
    public static int run (String argv[], PrintStream out) {
        ...
        int exitCode = new filter_rt004().runThis(argv, out);
    ...
    private String testedClassName1 =
      "nsk.jdi.WatchpointRequest.addClassFilter_rt.filter_rt004aTestClass10";
