 ...
 *   - creates a ModificationWatchpointRequest and enables it,          <BR>
...
public class instancefilter004 extends JDIBase {
    ...
    public static int run (String argv[], PrintStream out) {
        ...
        int exitCode = new instancefilter004().runThis(argv, out);
    ...
    private String testedClassName =
      "nsk.jdi.WatchpointRequest.addInstanceFilter.instancefilter004aTestClass";
