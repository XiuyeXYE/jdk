...
public class visiblevariables002 {
    ...
    public static int run (String argv[], PrintStream out) {
        return new visiblevariables002().runThis(argv, out);
    }
    ...
    private String testedClassName =
        "nsk.jdi.StackFrame.visibleVariables.Threadvisiblevariables002a";
    ...
    //------------------------------------------------------  testing section
        ...
        pipe.println("newcheck");
            ...
            label1: {
                ...
                log2("      invoking stackFrame.visibleVariables() first time before resuming thread2");
                try {
                    ...
                    log2("     :  AbsentInformationException for stackFrame.visiblevariables()");
                ...
                log2("      invoking stackFrame.visibleVariables() second time after resuming thread2");
                try {
                    visiblevars = stackFrame.visibleVariables();
                    ...
                    log2("     :  InvalidStackFrameExceprtion before the thread2 is resumed");
                }
            }
