 ...
 * is prepared with line number information,                    <BR>
 ...
 * sets up a breakpoint, and performs the following.                    <BR>
 * 1) After getting a thread2 suspended but before to resume it,        <BR>
 * StackFrame.visibleVariablesByName() is used to check up              <BR>
 * that the following is true:                                  <BR>
 *  - two visible variables - local in a tested method;         <BR>
 *  - invisible variable    - a class variable;                 <BR>
 *  - invisible variable    - local in another method;          <BR>
 *  - invisible variable    - local in the tested method.       <BR>
 * 2) After resuming the thread2, the tested method is invoked          <BR>
 *    second time and InvalidStackFrameException must be thrown.        <BR>
 * <BR>
 */

public class visiblevarbyname001 {
    ...
    public static int run (String argv[], PrintStream out) {
        return new visiblevarbyname001().runThis(argv, out);
    }
    ...
    private String testedClassName =
        "nsk.jdi.StackFrame.visibleVariableByName.Threadvisiblevarbyname001a";
    ...
    //------------------------------------------------------  testing section
        ...
        pipe.println("newcheck");
            ...
            label1: {
                ...
                String        name0   = "invi_i0";
                String        name1   = "vi_i1";
                String        name2   = "invi_i2";
                String        name3   = "invi_i3";
                ...
                label01: {
                    ...
                    try {
                        ...
                        if (locvar1 == null) {
                            log3("ERROR:  locvar1 == null for 'vi_i1'");
                            expresult = returnCode1;
                            break label01;
                        }
                        if (!locvar1.name().equals(name1)) {
                            log3("ERROR:  !locvar1.name().equals(name1)  for 'vi_i1'");
                            expresult = returnCode1;
                            break label01;
                        }
                        log2("      vi_i1 is OK");
                    } catch ( AbsentInformationException e1 ) {
                        log3("ERROR:  AbsentInformationException for locvar1");
                        expresult = returnCode1;
                    } catch ( InvalidStackFrameException e2 ) {
                        log3("ERROR:  InvalidStackFrameExceprtion before the thread2 is resumed");
                        expresult = returnCode1;
                    }
                }
                label02: {
                    log2("      checking up invisibility of invi_i0");
                    try {
                        locvar1 = stackFrame.visibleVariableByName(name0);
                        if (locvar1 != null) {
                            log3("ERROR:  locvar1 == null for 'invi_i0'");
                            expresult = returnCode1;
                            break label02;
                        }
                        log2("      invi_i0 is OK");
                ...
                label03: {
                    log2("      checking up invisibility of invi_i2");
                    try {
                        locvar1 = stackFrame.visibleVariableByName(name2);
                        if (locvar1 != null) {
                            log3("ERROR:  locvar1 != null for 'invi_i2'");
                            expresult = returnCode1;
                            break label03;
                        }
                        log2("      invi_i2 is OK");
                ...
                label04: {
                    log2("      checking up invisibility of invi_i3");
                    try {
                        locvar1 = stackFrame.visibleVariableByName(name3);
                        if (locvar1 != null) {
                            log3("ERROR:  locvar1 != null for 'invi_i3'");
                            expresult = returnCode1;
                            break label04;
                        }
                        log2("      invi_i3 is OK");
                ...
                try {
                    locvar2 = stackFrame.visibleVariableByName(name1);
                    log3("ERROR:  no InvalidStackFrameExceprtion after the thread2 is resumed");
                    expresult = returnCode1;
                    break label1;
                } catch ( AbsentInformationException e ) {
                    log3("ERROR:  AbsentInformationException for locvar2");
                    expresult = returnCode1;
                    break label1;
                } catch ( InvalidStackFrameException e ) {
                    log2("     :  InvalidStackFrameException for locvar2");
                }
