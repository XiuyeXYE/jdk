 ...
 * complies with its spec for a static method.                  <BR>
 * <BR>
 ...
 *    its returned value must be null.                                  <BR>
...
public class thisobject002 {
    ...
    public static int run (String argv[], PrintStream out) {
        return new thisobject002().runThis(argv, out);
    }
    ...
    private String testedClassName =
        "nsk.jdi.StackFrame.thisObject.Threadthisobject002a";
        ...
        pipe.println("newcheck");
            ...
            label1: {
                ...
                try {
                    ...
                    if (thisobj != null) {
                        log3("ERROR:  stackFrame.thisObject() != null for a static method");
                    expresult = returnCode1;
                    break label1;
                    }
