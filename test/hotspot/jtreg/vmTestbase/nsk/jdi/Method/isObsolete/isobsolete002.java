 ...
 * The test checks that isObsolete() returns true if            <BR>
 * the body of the tested method was fully replaced.            <BR>
 * <BR>
...
public class isobsolete002 extends JDIBase {
    ...
    public static int run (String argv[], PrintStream out) {
        ...
        int exitCode = new isobsolete002().runThis(argv, out);
        ...
        for (int i = 0; ; i++) {
            ...
            switch (i) {
              case 0:
                  ...
                  log2("......getting: redefClass = debuggee.classByName(className);");
                  redefClass = debuggee.classByName(className);

                  log2("......getting: Method method = debuggee.methodByName(redefClass, methodName);");
                  ...
                  if (isObs) {
                      log2("     : isObsolete() == true for m2 method after redefineClasses() invocation;");
                  } else {
                      log3("ERROR: isObsolete() == false for m2 method after redefineClasses() invocation");
                      testExitCode = FAILED;
                  }
                  break;
    ...
    private Map<? extends com.sun.jdi.ReferenceType,byte[]> mapClassToBytes()
        ...
        try {
            ...
            if (fileToRedefine.exists())
                log2("       fileToRedefine.exists();    length == " + fileToRedefine.length());
            else {
        ...
        String testClassName = "nsk.jdi.Method.isObsolete.isobsolete002b";
