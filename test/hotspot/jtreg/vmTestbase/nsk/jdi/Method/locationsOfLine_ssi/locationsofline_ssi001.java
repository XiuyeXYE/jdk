 ...
 * <code>com.sun.jdi.Method.locationsOfLine(String, String, int)</code>         <BR>
 * complies with its spec.                                      <BR>
 * <BR>
 * The test checks up that for each line in the List returned   <BR>
 * by the method Method.allLineLocations(), the method          <BR>
 * locationsOfLine(defaultStratum, null, lineNumber) returns    <BR>
 *      non-empty List object in which                          <BR>
 *      each object is a Location object.                       <BR>
 * Not throwing  AbsentInformationException                     <BR>
 * is checked up as well.                                       <BR>
 * <BR>
 */

public class locationsofline_ssi001 {
    ...
    public static int run (String argv[], PrintStream out) {
        ...
        return new locationsofline_ssi001().runThis(argv, out);
    }
    ...
    String mName = "nsk.jdi.Method.locationsOfLine_ssi";
    ...
    //------------------------------------------------------  testing section
        ...
        for (int i = 0; ; i++) {
            ...
            log2("      neither AbsentInformationException no InvalidLineNumberException is expected");
            ...
            label1:
                for (int ifor1 = 0; ifor1 < size; ifor1++) {
                    ...
                    try {
                        log2("......List lineLocations = m.locationsOfLine(defaultStratum, null, " + lineNumber + ");");
                        List lineLocations = m.locationsOfLine(defaultStratum, null, lineNumber);
