 ...
 * <code>com.sun.jdi.StepRequest.size()</code>                  <BR>
 * complies with its spec.                                      <BR>
 * <BR>
 * The test checks if an int value StepRequest.STEP_LINE,               <BR>
 * an argument of the method                                            <BR>
 *    EventRequestManager.createAccessWatchpointRequest(),              <BR>
 * is equal to one returned by the method StepRequest.size()            <BR>
 * <BR>
 ...
 *   - creates an StepRequest with the size StepRequest.STEP_LINE,      <BR>
 *   - gets  the size of the Request with the method StepRequest.size(),<BR>
...
public class size002 extends JDIBase {
    ...
    public static int run (String argv[], PrintStream out) {
        ...
        int exitCode = new size002().runThis(argv, out);
    ...
    private String testedClassName =
      "nsk.jdi.StepRequest.size.size002aTestClass10";
        ...
        for (int i = 0; ; i++) {
            ...
            switch (i) {
              ...
              case 0:
                     ...
                     log2("......getting: size = ((StepRequest) eventRequest1).size();");
                     size = ((StepRequest) eventRequest1).size();

                     log2("      checking up on equality of values");
                     if ( size != StepRequest.STEP_LINE ) {
                         testExitCode = FAILED;
                         log3("ERROR: size() != StepRequest.STEP_LINE : " + size);
                     }
