 ...
 * <BR>
 * The test checks if an int value StepRequest.STEP_MIN,                <BR>
 ...
 *   - creates an StepRequest with the size StepRequest.STEP_MIN,       <BR>
...
public class size001 extends JDIBase {
    ...
    public static int run (String argv[], PrintStream out) {
        ...
        int exitCode = new size001().runThis(argv, out);
    ...
    private String testedClassName =
      "nsk.jdi.StepRequest.size.TestClass10";
            ...
            switch (i) {
              ...
              case 0:
                     ...
                     if ( size != StepRequest.STEP_MIN ) {
                         testExitCode = FAILED;
                         log3("ERROR: size() != StepRequest.STEP_MIN : " + size);
                     }
