 ...
 * <BR>
 * The test checks if an int value StepRequest.STEP_OVER,               <BR>
 ...
 *   - creates an StepRequest with the depth StepRequest.STEP_OVER,     <BR>
...
public class depth002 extends JDIBase {
    ...
    public static int run (String argv[], PrintStream out) {
        ...
        int exitCode = new depth002().runThis(argv, out);
    ...
    private String testedClassName =
      "nsk.jdi.StepRequest.depth.depth002aTestClass10";
            ...
            switch (i) {
              ...
              case 0:
                     ...
                     if ( depth != StepRequest.STEP_OVER ) {
                         testExitCode = FAILED;
                         log3("ERROR: depth() != StepRequest.STEP_OVER : " + depth);
                     }
