 ...
 * <code>com.sun.jdi.StepRequest.addClassFilter()</code> <BR>
 ...
 * - The debuggee creates and starts a thread, thread1, and             <BR>
 *   invokes the methodForCommunication to be suspended                 <BR>
 *   and to inform the debugger with the event.                         <BR>
 * - Upon getting the BreakpointEvent, the debugger                     <BR>
 *   - creates a StepRequest and enables it,                            <BR>
...
public class filter_s002 extends JDIBase {
    ...
    private String testedClassName1 =
      "nsk.jdi.StepRequest.addClassFilter_s.TestClass10";
            ...
            switch (i) {
              ...
              case 0:
                     ...
                     try {
                         ...
                         ((StepRequest)eventRequest1).addClassFilter(testedClassName1);
