...
package nsk.jdi.Mirror.toString;
 ...
 * <code>com.sun.jdi.Mirror.toString()</code>                   <BR>
 ...
 * applies the method Mirror.toString() to the object.          <BR>
...
public class tostring001 {
    ...
    public static int run (String argv[], PrintStream out) {
        return new tostring001().runThis(argv, out);
    }
    ...
    //String mName = "nsk.jdi.Mirror.toString";
    ...
    //------------------------------------------------------  testing section
        ...
        for (int i = 0; ; i++) {
            ...
            log2("      String str = testClass.toString();");
            String str = testClass.toString();

            log2("      checking up on 'str' value; null is not expected");
            if (str == null) {
                log3("ERROR: str == null");
                testExitCode = FAILED;
            } else {
                int lenght = str.length();
                log2("       str.length() == " + lenght);
            }
