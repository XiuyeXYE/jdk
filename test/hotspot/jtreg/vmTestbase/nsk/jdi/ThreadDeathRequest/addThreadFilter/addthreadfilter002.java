 ...
 * <BR>
 * In second phase, the debugger creates ThreadDeathRequest             <BR>
    ...
    */
    ...
    //------------------------------------------------------  testing section
        ...
        for (int i = 0; ; i++) {
            ...
            log2("...... ThreadDeathRequest tdr1 = eventRManager.createThreadDeathRequest();");
            ...
            try {
                log2("...... tdr1.addThreadFilter(mainThread);");
            ...
            try {
                log2("...... tdr1.addThreadFilter(null);");
                log2("         NullPointerException is expected");
                tdr1.addThreadFilter(null);
