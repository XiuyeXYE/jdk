...
public class addthreadfilter005 extends JDIBase {
    ...
    private String testedClassName =
      "nsk.jdi.ThreadDeathRequest.addThreadFilter.addthreadfilter005aTestClass";
    ...
    */
    ...
    //------------------------------------------------------  testing section
        ...
        String property2 = "ThreadDeathRequest2";
        String property3 = "ThreadDeathRequest3";
        ...
        for (int i = 0; ; i++) {
            ...
            switch (i) {
              ...
              case 1:
                      eventRequest2 = setting2ThreadDeathRequest (null,
                                             EventRequest.SUSPEND_NONE, property2);

                      try {
                          log2("......eventRequest2.addThreadFilter(thread1);");
                          log2("        no Exception expected");
                          ((ThreadDeathRequest)eventRequest2).addThreadFilter(thread1);
                      } catch ( Exception e ) {
                          log3("ERROR: Exception : " + e);
                          testExitCode = FAILED;
                      }
              ...
              case 2:
                      eventRequest3 = setting2ThreadDeathRequest (null,
                                             EventRequest.SUSPEND_NONE, property3);

                      try {
                          log2("......eventRequest3.addThreadFilter(thread1);");
                          log2("        no Exception expected");
                          ((ThreadDeathRequest)eventRequest3).addThreadFilter(thread1);
                      } catch ( Exception e ) {
                          log3("ERROR: Exception : " + e);
                          testExitCode = FAILED;
                      }
