 ...
 * - The debugger creates three ThreadDeathRequests with                <BR>
 *   addThreadFilter(debuggee's thread2) invoked only on third Request, <BR>
 *   resumes the debuggee and waits for the ThreadDeathEvent.           <BR>
 ...
 * - Upon getting ThreadDeathEvent, the debugger checks                 <BR>
