 ...
 * <code>com.sun.jdi.MethodExitRequest.addClassExclusionFilter()</code> <BR>
...
public class filter002 extends JDIBase {
    ...
    private String testedClassName1 =
      "nsk.jdi.MethodExitRequest.addClassExclusionFilter.TestClass10";
    ...
    //------------------------------------------------------  testing section
        ...
        for (int i = 0; ; i++) {
            ...
            switch (i) {
              ...
              case 0:
                     eventRequest1 = setting23MethodExitRequest(null, testedClassName1,
                     ...
                     try {
                         ...
                         ((MethodExitRequest)eventRequest1).addClassFilter(testedClassName1);
