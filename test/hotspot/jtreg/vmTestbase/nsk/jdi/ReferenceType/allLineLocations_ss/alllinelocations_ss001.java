 ...
 * <code>com.sun.jdi.ReferenceType.allLineLocations(String,String)</code> <BR>
 * The test checks up that a list of locations for              <BR>
 * a tested ReferenceType object                                <BR>
 *    - is not empty and                                        <BR>
...
public class alllinelocations_ss001 {
    ...
    String mName = "nsk.jdi.ReferenceType.allLineLocations_ss";
    ...
    //------------------------------------------------------  testing section
        ...
        for (int i = 0; ; i++) {
            ...
            log2("......locations = refType.allLineLocations(defaultStratum, null);");
            log2("       no AbsentInformationException is expected");
            try {
                locations = refType.allLineLocations(defaultStratum, null);
