 ...
 * <code>com.sun.jdi.ReferenceType.isStatic()</code>            <BR>
 * complies with its spec.                                      <BR>
 * <BR>
 * Cases for testing include :                                  <BR>
 * - nested and outer ClassTypes and InterfaceTypes,            <BR>
 *   and nested ArrayTypes;                                     <BR>
...
public class isstatic001 extends JDIBase {
    ...
    public static int run (String argv[], PrintStream out) {
        ...
        int exitCode = new isstatic001().runThis(argv, out);
    ...
    String mName = "nsk.jdi.ReferenceType.isStatic";
    ...
    //------------------------------------------------------  testing section
        ...
        for (int i = 0; ; i++) {
           ...
           String names1[] = {
                      ...
                      ".isstatic001aTestClass$NestedClass",         "f",
                      ".isstatic001aTestClass$NestedClass[]",       "f",
                      ".isstatic001aTestClass$NestedIface",         "t",
                      ".isstatic001aTestClass$StaticNestedClass",   "t",
                      ".isstatic001aOuterClass",                    "f",
                      ".isstatic001aOuterClass[]",                  "f",
                      ".isstatic001aOuterIface",                    "f",
                      ".isstatic001aOuterIface[]",                  "f",
                      ".isstatic001aOuterIface$InnerIface",         "t",
                      ".isstatic001aOuterIface$StaticInnerIface",   "t"
            ...
            for (int i1 = 0; i1 < names1.length; i1 += 2) {
                ...
                log2("      getting: boolean isStatic = referenceType.isStatic();");
