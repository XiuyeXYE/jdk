...
public class isstatic002 extends JDIBase {
    ...
    public static int run (String argv[], PrintStream out) {
        ...
        int exitCode = new isstatic002().runThis(argv, out);
    ...
    //------------------------------------------------------  testing section
        ...
        for (int i = 0; ; i++) {
            ...
            String names1[] = {
                      ...
                      ".isstatic002aTestClass$NestedIface1[]",      "f",
                      ".isstatic002aTestClass$NestedIface2[]",      "f",
                      ".isstatic002aTestClass$StaticNestedClass[]", "f"
            };
