 ...
 * <code>com.sun.jdi.ReferenceType.locationsOfLine(String,String,int)</code> <BR>
 ...
 * the method locationsOfLine(defaultStratum,null,lineNumber)   <BR>
 * returns non-empty List object                                <BR>
 * in which each object is a Location object.<BR>
...
public class locationsofline_ssi001 {
    ...
    String mName = "nsk.jdi.ReferenceType.locationsOfLine_ssi";
        ...
        for (int i = 0; ; i++) {
            ...
            label1:
                for (int ifor1 = 0; ifor1 < size; ifor1++) {
                    ...
                    try {
                        log2("......List lineLocations = refType.locationsOfLine(defaultStratum, null, " + lineNumber + ");");
                        List lineLocations = refType.locationsOfLine(defaultStratum, null, lineNumber);
