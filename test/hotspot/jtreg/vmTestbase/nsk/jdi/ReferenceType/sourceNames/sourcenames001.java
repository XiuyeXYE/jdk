 ...
 * <code>com.sun.jdi.ReferenceType.sourceNames(String)</code>   <BR>
 ...
 * A debugger gets ReferenceType object, mirroring tested Class and     <BR>
 * performs the following:                                              <BR>
 * - gets a List returned by the method                                 <BR>
 *    ReferenceType.sourceNames(defaultStratum);                        <BR>
 * - checks that the List contains only one String element which,       <BR>
 *    is equal to the predefined one.                                   <BR>
 */

public class sourcenames001 {
    ...
    public static int run (String argv[], PrintStream out) {
        ...
        return new sourcenames001().runThis(argv, out);
    }
    ...
    //String mName = "nsk.jdi.ReferenceType.sourceNames";
    ...
    //------------------------------------------------------  testing section
        ...
        for (int i = 0; ; i++) {
            ...
            log2("......checking up on equality: sourceName.equals('sourcenames001a.java')");
            if (!sourceName.equals("sourcenames001a.java")) {
               log3("ERROR: sourceName is not equal to 'sourcenames001a.java'  : " + sourceName);
               testExitCode = FAILED;
            }
