 ...
 * in a superinterface and an implemented interface.            <BR>
 * <BR>
...
public class getvalue003 extends JDIBase {
    ...
    public static int run (String argv[], PrintStream out) {
        ...
        int exitCode = new getvalue003().runThis(argv, out);
    ...
    private String testedClassName =
      "nsk.jdi.ReferenceType.getValue.getvalue003aTestClass";
