 ...
 * EVENT_THREAD, and ALL, for BreakpointEvent sets.             <BR>
 * <BR>
 ...
 * - The debugger sets up a BreakpointRequest, resumes                  <BR>
 *   the debuggee, and waits for the BreakpointEvent.                   <BR>
...
public class resume004 extends JDIBase {
    ...
    public static int run (String argv[], PrintStream out) {
        ...
        int exitCode = new resume004().runThis(argv, out);
    ...
    //------------------------------------------------------  testing section
        ...
        for (int i = 0; ; i++) {
            ...
            if ( !(newEvent instanceof BreakpointEvent)) {
                ...
                log2("       got new BreakpointEvent with propety 'number' == " + property);
                ...
                switch (policy) {
                  ...
                  case SUSPEND_THREAD :
                       ...
                       for (String threadName : suspendsCounts1.keySet()) {
                           ...
                           int count1 = suspendsCounts1.get(threadName);
                           int count2 = suspendsCounts2.get(threadName);
                           String eventThreadName = ((BreakpointEvent)newEvent).thread().name();
