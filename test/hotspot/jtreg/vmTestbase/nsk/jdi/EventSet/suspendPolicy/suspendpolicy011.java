 ...
 * The cases to check include event set containing              <BR>
 * one more VMDeathRequest with suspendPolicy SUSPEND_NONE.     <BR>
 * <BR>
...
public class suspendpolicy011 extends JDIBase {
    ...
    public static int run (String argv[], PrintStream out) {
        ...
        int exitCode = new suspendpolicy011().runThis(argv, out);
    ...
    */
    ...
    //------------------------------------------------------  testing section
        ...
        policyToCheck = policyExpected[0];
        mainThread.resume();
