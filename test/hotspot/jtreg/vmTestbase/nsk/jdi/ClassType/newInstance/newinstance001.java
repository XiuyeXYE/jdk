 ...
 * new instance of the class TestClass                          <BR>
 * which is global to a class implementing debuggee's thread    <BR>
 * in which instance creation is performed.                     <BR>
 ...
 * a returned ObjectReference value;                            <BR>
 * the following  is expected to be true:                       <BR>
    ...
    //------------------------------------------------------  testing section
        ...
        for (int i = 0; ; i++) {
            ...
            label1: {
                ...
                List<Method> argumentListm = testedClass.methodsByName("m");
                log2("       argumentList.clear();");
                argumentListm.clear();
                List<? extends Value> argumentList = Collections.emptyList();
