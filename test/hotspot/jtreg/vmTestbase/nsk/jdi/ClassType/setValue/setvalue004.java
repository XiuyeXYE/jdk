 ...
 * <BR>
 * After being started up, a debuggee creates all the primitive type    <BR>
 * objects and one of the Object type,                                  <BR>
...
public class setvalue004 {
    ...
    //------------------------------------------------------  testing section
        ...
        for (int i = 0; ; i++) {
            ...
            log2("      checking up on exception for: setValue(primitivetype variable, null);");
            for ( int i2 = 0; i2 < 8; i2++ ) {

                try {
                    field1 = debuggeeclass.fieldByName(names[i2]);
                    log2("      checking up on exception for: Field of " + field1.typeName() + "  type");
                    dClass.setValue(field1, null);
            ...
            log2("      checking up on exception for: setValue(Object variable, null);");
            try {
                field1 = debuggeeclass.fieldByName(name);
                if (field1 != null) {
                    dClass.setValue(field1, null);
                    log2("     : no Exception");
                } else {
                    log3("ERROR: field1 == null after: field1 = debuggeeclass.fieldByName(name);");
                    testExitCode = FAILED;
                }
            } catch ( java.lang.IllegalArgumentException e1 ) {
                    log3("ERROR:  java.lang.IllegalArgumentException ");
