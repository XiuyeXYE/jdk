...
public class addthreadfilter005 extends JDIBase {
    ...
    private String testedClassName =
      "nsk.jdi.ThreadStartRequest.addThreadFilter.addthreadfilter005aTestClass";
    ...
    */
    ...
    //------------------------------------------------------  testing section
        ...
        String property3 = "ThreadStartRequest3";
        ...
        for (int i = 0; ; i++) {
            ...
            switch (i) {
              ...
              case 1:
                      eventRequest2 = setting2ThreadStartRequest (null,
                                             EventRequest.SUSPEND_NONE, property2);

                      try {
                          log2("......eventRequest2.addThreadFilter(thread1);");
                          log2("        no Exception expected");
                          ((ThreadStartRequest)eventRequest2).addThreadFilter(thread1);
                      } catch ( Exception e ) {
                          log3("ERROR: Exception : " + e);
                          testExitCode = FAILED;
                      }
              ...
              case 2:
                      eventRequest3 = setting2ThreadStartRequest (null,
                                             EventRequest.SUSPEND_NONE, property3);

                      try {
                          log2("......eventRequest3.addThreadFilter(thread1);");
                          log2("        no Exception expected");
                          ((ThreadStartRequest)eventRequest3).addThreadFilter(thread1);
                      } catch ( Exception e ) {
                          log3("ERROR: Exception : " + e);
                          testExitCode = FAILED;
                      }
