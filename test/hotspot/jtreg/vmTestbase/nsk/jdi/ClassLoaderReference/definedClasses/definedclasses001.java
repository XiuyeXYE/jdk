 ...
 * <code>com.sun.jdi.ClassLoader.definedClasses()</code>        <BR>
 * complies with its spec.                                      <BR>
 * <BR>
 * The test checks up on the following assertion:               <BR>
 *    The list has length 0 if no types have been defined by    <BR>
 *    this classloader.                                         <BR>
 * <BR>
...
public class definedclasses001 extends JDIBase {
    ...
    public static int run (String argv[], PrintStream out) {
        ...
        int exitCode = new definedclasses001().runThis(argv, out);
    ...
    */
    ...
    //------------------------------------------------------  testing section
        ...
        for (int i = 0; ; i++) {
            ...
            List definedClasses = clRef.definedClasses();
            log2("......checking up on definedClasses.size() :  0 is expected");
            if (definedClasses.size() != 0) {
                log3("ERROR: definedClasses.size() != 0");
                testExitCode = FAILED;
            }
