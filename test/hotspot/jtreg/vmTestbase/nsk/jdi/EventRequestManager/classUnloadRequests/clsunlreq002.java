 ...
 * <code>com.sun.jdi.EventRequestManager.classUnloadRequests()</code> <BR>
 * complies with its spec.                                      <BR>
 * <BR>
 * The test checks up on the following assertion:                       <BR>
 * - The list is unmodifiable.                                          <BR>
 * - The list of the enabled and disabled class unload requests.        <BR>
...
public class clsunlreq002 extends JDIBase {
    ...
    public static int run (String argv[], PrintStream out) {
        ...
        int exitCode = new clsunlreq002().runThis(argv, out);
    ...
    */
    ...
    //------------------------------------------------------  testing section
        ...
        ClassUnloadRequest request = null;
        ClassUnloadRequest cuRequests[] = { null, null, null, null, null,
        ...
        for (int i = 0; ; i++) {
            ...
            log2("......creating ClassUnloadRequests");
            for (int i1 = 0; i1 < cuRequests.length; i1++) {
                cuRequests[i1] = eventRManager.createClassUnloadRequest();
                cuRequests[i1].putProperty("number", String.valueOf(i1));

                log2("......checking up on returned List after creating new ClassUnloadRequest");
                requests = eventRManager.classUnloadRequests();
                ...
                while (li.hasNext()) {
                    request = (ClassUnloadRequest) li.next();
                ...
                log2("      enabling created ClassUnloadRequest");
            ...
            log2("......deleting ClassUnloadRequests");
