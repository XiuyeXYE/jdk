 ...
 * <code>com.sun.jdi.EventRequestManager.createVMDeathRequest()</code> <BR>
 * complies with its spec.                                      <BR>
 * <BR>
 * The test checks up on the following assertions:              <BR>
 *  - Creates a new disabled VMDeathRequest.                    <BR>
 *  - Throws: UnsupportedOperationException -                   <BR>
 *            if the target VM does not support this operation. <BR>
 * <BR>
...
public class vmdreg001 extends JDIBase {
    ...
    public static int run (String argv[], PrintStream out) {
        ...
        int exitCode = new vmdreg001().runThis(argv, out);
