 ...
 * <code>com.sun.jdi.EventRequestManager.createThreadDeathRequest()</code> <BR>
...
public class tdreg001 extends JDIBase {
    ...
    public static int run (String argv[], PrintStream out) {
        ...
        int exitCode = new tdreg001().runThis(argv, out);
    ...
    */
    ...
    //------------------------------------------------------  testing section
        ...
        for (int i = 0; ; i++) {
            ...
            log2("......creating: tdRequest1 = eventRManager.createThreadDeathRequest();");
            tdRequest1 = eventRManager.createThreadDeathRequest();
            log2("      checking up on if request is disabled");
            if (tdRequest1.isEnabled()) {
                testExitCode = FAILED;
