...
public class crstepreq007 {
    ...
    private final static String className = ".crstepreq007";
    ...
    static final String debuggeeThreadName = prefix + ".Thread0crstepreq007a";

    //------------------------------------------------------ mutable common methods

    public static int run (String argv[], PrintStream out) {

        int exitStatus = new crstepreq007().runThis(argv, out);
