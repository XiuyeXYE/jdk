...
package nsk.jdi.EventRequestManager.createClassUnloadRequest;
 ...
 * <code>com.sun.jdi.EventRequestManager.createClassUnloadRequest()</code> <BR>
 * complies with its spec.                                      <BR>
 * <BR>
 * The test checks up on the following assertion:               <BR>
 *  - Creates a new disabled ClassUnloadRequest.                <BR>
 * <BR>
...
public class cureg001 extends JDIBase {
    ...
    public static int run (String argv[], PrintStream out) {
        ...
        int exitCode = new cureg001().runThis(argv, out);
    ...
    */
    ...
    //------------------------------------------------------  testing section
        ...
        ClassUnloadRequest cuRequest1 = null;
        ...
        for (int i = 0; ; i++) {
            ...
            log2("......creating: cuRequest1 = eventRManager.createClassUnloadRequest();");
            cuRequest1 = eventRManager.createClassUnloadRequest();
            log2("      checking up on if request is disabled");
            if (cuRequest1.isEnabled()) {
                testExitCode = FAILED;
