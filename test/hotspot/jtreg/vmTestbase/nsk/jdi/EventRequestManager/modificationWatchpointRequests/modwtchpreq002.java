 ...
 * <code>com.sun.jdi.EventRequestManager.modificationWatchpointRequests()</code> <BR>
 ...
 *   the debugger checks up on assertions.                              <BR>
 * <BR>
...
public class modwtchpreq002 extends JDIBase {
    ...
    public static int run (String argv[], PrintStream out) {
        ...
        int exitCode = new modwtchpreq002().runThis(argv, out);
    ...
    */
    ...
    //------------------------------------------------------  testing section
        ...
        ModificationWatchpointRequest awRequests[] = { null, null, null, null, null,
        ...
        for (int i = 0; ; i++) {
            ...
            log2("......creating ModificationWatchpointRequests");
            for (int i1 = 0; i1 < awRequests.length; i1++) {
                awRequests[i1] = eventRManager.createModificationWatchpointRequest(field);
                awRequests[i1].putProperty("number", String.valueOf(i1));

                log2("......checking up on returned List after creating new ModificationWatchpointRequest");
                ...
                while (li.hasNext()) {
                    request = (ModificationWatchpointRequest) li.next();
                ...
                log2("      enabling created ModificationWatchpointRequest");
            ...
            log2("......deleting ModificationWatchpointRequests");
