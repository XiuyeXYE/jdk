...
package nsk.jdi.Location.hashCode;
 ...
 * <code>com.sun.jdi.Location.hashCode()</code>                 <BR>
 ...
 *   return ints equal to each other;                                   <BR>
 * - two invocations on different Locations return ints                 <BR>
...
public class hashcode001 {
    ...
    String mName = "nsk.jdi.Location.hashCode";
    ...
    //------------------------------------------------------  testing section
        ...
        for (int i = 0; ; i++) {
            ...
            log2("......checking up Location's hashCodes");
            ...
            for (int ifor = 0; li.hasNext(); ifor++) {
                ...
                int hcode1 = loc1.hashCode();
                int hcode2 = loc2.hashCode();
                int hcode3 = loc3.hashCode();

                if (hcode1 != hcode2) {
                    log3("ERROR: loc1.hashCode() != loc2.hashCode()   ifor : " + ifor);
                    testExitCode = FAILED;
                }
                loc1 = loc3;
            }
