 ...
 * <code>com.sun.jdi.Location.lineNumber()</code>               <BR>
 * complies with its spec.                                      <BR>
 * Case for testing includes only a List of locations returned  <BR>
 * by the method ReferenceType.allLineLocations(), hence        <BR>
 * no -1 returned by Location.lineNumber() is expected.         <BR>
 */

public class linenumber001 {
    ...
    public static int run (String argv[], PrintStream out) {
        return new linenumber001().runThis(argv, out);
    }
    ...
    String mName = "nsk.jdi.Location.lineNumber";
    ...
    //------------------------------------------------------  testing section
        ...
        for (int i = 0; ; i++) {
            ...
            for (int ifor = 0; li.hasNext(); ifor++) {
                int lineNumber = ((Location) li.next()).lineNumber();
