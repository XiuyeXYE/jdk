...
package nsk.jdi.Location.sourcePath;
 ...
 * <code>com.sun.jdi.Location.sourcePath()</code>               <BR>
...
public class sourcepath001 {
    ...
    public static int run (String argv[], PrintStream out) {
        ...
        return new sourcepath001().runThis(argv, out);
    }
    ...
    String mName = "nsk.jdi.Location.sourcePath";
    ...
    //------------------------------------------------------  testing section
        ...
        for (int i = 0; ; i++) {
            ...
            String debuggeeUnqualifiedSourcePath = "nsk" + sep + "jdi" +sep + "Location" + sep +
                                                  "sourcePath" + sep + "sourcepath001a.java";

            log2("......getting: String str = loc.sourcePath()");
            try {
                String str = loc.sourcePath();

                log2("......compareing: loc.sourcePath() to debuggeeUnqualifiedSourcePath");
                if (!str.equals(debuggeeUnqualifiedSourcePath)) {
                    log3("ERROR: loc.sourcePath() != debuggeeUnqualifiedSourcePath");
                    log2("        loc.sourcePath()              == " + str);
