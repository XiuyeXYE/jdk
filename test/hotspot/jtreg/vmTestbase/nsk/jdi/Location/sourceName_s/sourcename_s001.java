 ...
 * <code>com.sun.jdi.Location.sourceName(String stratum)</code> <BR>
 ...
 * A debugger gets ReferenceType objects, mirroring tested Class and    <BR>
 * performs the following:                                              <BR>
 * - gets a List returned by the method testedClass.allLineLocations(); <BR>
 * - perform a loop to check up that for each Location in the List,     <BR>
 * the method Location.sourceName(defaultStratum)                       <BR>
 * returns String equal to the predefined one.                          <BR>
 */

public class sourcename_s001 {
    ...
    public static int run (String argv[], PrintStream out) {
        ...
        return new sourcename_s001().runThis(argv, out);
    }
    ...
    String mName = "nsk.jdi.Location.sourceName_s";
    ...
    //------------------------------------------------------  testing section
        ...
        for (int i = 0; ; i++) {
            ...
            log2("......checking up on sourceName strings in all Locations");
            log2("       only 'sourcename_s001a.java' is expected");
            ...
            for (int ifor = 0; li.hasNext(); ifor++) {
                ...
                try {
                    String str = loc.sourceName(defaultStratum);
                    if (!str.equals("sourcename_s001a.java")) {
                        log3("ERROR: !str.equals('sourcename_s001a.java') : " + str);
                        testExitCode = FAILED;
                    }
                } catch ( AbsentInformationException e ) {
                    log3("ERROR: AbsentInformationException");
