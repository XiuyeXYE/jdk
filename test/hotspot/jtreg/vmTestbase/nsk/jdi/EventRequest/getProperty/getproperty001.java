 ...
 * <code>com.sun.jdi.EventRequest.getProperty()</code>          <BR>
 * complies with its spec.                                      <BR>
 * <BR>
 * The test checks up on following assertions:                  <BR>
 * - a value of property is equal to one assigned with method   <BR>
 *   putProperty(key, value);
 * - the value of the property which is not assign with method  <BR>
 *   putProperty(key, value),  is the null.                     <BR>
...
public class getproperty001 extends JDIBase {
    ...
    public static int run (String argv[], PrintStream out) {
        ...
        int exitCode = new getproperty001().runThis(argv, out);
    ...
    */
    ...
    //------------------------------------------------------  testing section
        ...
        for (int i = 0; ; i++) {
            ...
            log2("......eventRequest1.putProperty(propertyName1, propertyValue1);");
            eventRequest1.putProperty(propertyName1, propertyValue1);

            log2("      checking up on property1");
            if ( !eventRequest1.getProperty(propertyName1).equals(propertyValue1) ) {
                testExitCode = FAILED;
                log3("ERROR: property is not expected");
            };

            log2("      checking up on property2");
            if ( eventRequest1.getProperty(propertyName2)!= null ) {
                testExitCode = FAILED;
