 ...
 * <code>com.sun.jdi.EventRequest.addCountFilter()</code>       <BR>
 ...
 *  - Throws: IllegalArgumentException - if count is less than one.     <BR>
...
public class addcountfilter001 extends JDIBase {
    ...
    public static int run (String argv[], PrintStream out) {
        ...
        int exitCode = new addcountfilter001().runThis(argv, out);
    ...
    */
    ...
    //------------------------------------------------------  testing section
        ...
        for (int i = 0; ; i++) {
            ...
            try {
                log2("......eventRequest1.addCountFilter(-1); IllegalArgumentException is expected");
                eventRequest1.addCountFilter(-1);
                testExitCode = FAILED;
            ...
            try {
                log2("......eventRequest1.addCountFilter(0); IllegalArgumentException is expected");
                eventRequest1.addCountFilter(0);
                testExitCode = FAILED;
                log3("ERROR: NO IllegalArgumentException");
            } catch ( IllegalArgumentException e ) {
                log2("       IllegalArgumentException");
            ...
            try {
                log2("......eventRequest1.addCountFilter(1); no IllegalArgumentException is expected");
                eventRequest1.addCountFilter(1);
                log2("       no IllegalArgumentException");
            } catch ( IllegalArgumentException e ) {
                testExitCode = FAILED;
            ...
            try {
                ...
                log2("      eventRequest1.addCountFilter(1); InvalidRequestStateException is expected");
                eventRequest1.addCountFilter(1);
                testExitCode = FAILED;
