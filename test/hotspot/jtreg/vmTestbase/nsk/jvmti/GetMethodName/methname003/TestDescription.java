 ...
 * @test
 *
 * @summary converted from VM Testbase nsk/jvmti/GetMethodName/methname003.
 * VM Testbase keywords: [quick, jpda, jvmti, noras]
 * VM Testbase readme:
 * DESCRIPTION
 *     This test checks that the JVMTI function GetMethodName() returns
 *     generic signature information for methods properly.
 ...
 * @library /vmTestbase
 *          /test/lib
 * @run main/othervm/native -agentlib:methname003=-waittime=5 nsk.jvmti.GetMethodName.methname003
 */
