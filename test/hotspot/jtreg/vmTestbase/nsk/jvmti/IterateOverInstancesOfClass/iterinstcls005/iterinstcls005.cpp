...
static const char debugeeClassSignature[] = "Lnsk/jvmti/IterateOverInstancesOfClass/iterinstcls005;";
...
agentProc(jvmtiEnv* jvmti, JNIEnv* jni, void* arg) {
    ...
    do {
        ...
        if (objCounter == 0) {
            NSK_COMPLAIN0("IterateOverInstancesOfClass call had not visited any object\n");
            nsk_jvmti_setFailStatus();
        }
    } while (0);
...
#ifdef STATIC_BUILD
JNIEXPORT jint JNICALL Agent_OnLoad_iterinstcls005(JavaVM *jvm, char *options, void *reserved) {
    return Agent_Initialize(jvm, options, reserved);
}
JNIEXPORT jint JNICALL Agent_OnAttach_iterinstcls005(JavaVM *jvm, char *options, void *reserved) {
    return Agent_Initialize(jvm, options, reserved);
}
JNIEXPORT jint JNI_OnLoad_iterinstcls005(JavaVM *jvm, char *options, void *reserved) {
