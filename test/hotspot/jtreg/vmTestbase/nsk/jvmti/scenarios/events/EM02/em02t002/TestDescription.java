 ...
 *     Test executes the following several steps for events
 *     GARBAGE_COLLECTION_OCCURRED, GARBAGE_COLLECTION_START,
 *     GARBAGE_COLLECTION_FINISH:
 *       (1)
 *         - adds the <can_generate_garbage_collection_events> capability in
 *           the OnLoad phase
