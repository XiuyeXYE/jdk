 ...
 * @test
 *
 * @summary converted from VM Testbase nsk/jvmti/scenarios/events/EM02/em02t001.
 ...
 *     Test executes the following several steps for events MONITOR_WAIT,
 *     MONITOR_WAITED, MONITOR_CONTENDED_ENTER, MONITOR_CONTENDED_ENTERED:
 *       (1)
 *         - adds the <can_generate_monitor_events> capability in the OnLoad phase
 *         - sets callbacks for VM_INIT and events of optional functionality
 ...
 * @library /vmTestbase
 *          /test/lib
 * @build nsk.jvmti.scenarios.events.EM02.em02t001
 * @run main/othervm/native ExecDriver --java
 *      -agentlib:em02t001=-waittime=5
