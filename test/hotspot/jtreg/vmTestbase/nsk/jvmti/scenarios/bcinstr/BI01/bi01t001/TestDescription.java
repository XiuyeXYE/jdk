 ...
 * @test
 *
 * @summary converted from VM Testbase nsk/jvmti/scenarios/bcinstr/BI01/bi01t001.
 ...
 *         - load a class by a custom loader, source of loaded class is
 *           loadclass/bi01t001a.java;
 *         - instrument methodA() on receiving CLASS_FILE_LOAD_HOOK event;
 *         - check that instrumentation codes work correctly for every case;
 *         - redefine the tested class with original byte code version;
 ...
 * @library /vmTestbase
 *          /test/lib
 * @build nsk.jvmti.scenarios.bcinstr.BI01.bi01t001
 *
 ...
 *      -agentlib:bi01t001=-waittime=5
 *      nsk.jvmti.scenarios.bcinstr.BI01.bi01t001
 *      ./bin
 */
