 ...
 * @test
 *
 * @summary converted from VM Testbase nsk/jvmti/scenarios/allocation/AP04/ap04t003.
 ...
 *   The test class 'ap04t003' contains self-typed array field
 ...
 *   notification on start of auxuliary thread, the test agent
 *   starts new agent thread with RunAgentThread which modifies
 *   tag of each even tagged object. The test fails if tags of
 *   any objects were modified during heap iteration.
 * COMMENTS
