 ...
 * @test
 *
 * @summary converted from VM Testbase nsk/jvmti/scenarios/capability/CM01/cm01t008.
 * VM Testbase keywords: [quick, jpda, jvmti, noras, redefine]
 * VM Testbase readme:
 * DESCRIPTION
 *     The test is for CM01 scenario of "capability management".
 *     This test checks capability can_redefine_classes
 ...
 *     - change signature of ClassFileLoadHook callback
 ...
 *      -agentlib:cm01t008=-waittime=5
 *      nsk.jvmti.scenarios.capability.CM01.cm01t008
 */
