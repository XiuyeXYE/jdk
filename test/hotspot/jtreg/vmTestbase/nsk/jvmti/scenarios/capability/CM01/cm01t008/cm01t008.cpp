...
/* The test checks capability can_redefine_classes
...
const char* CLASS_NAME = "nsk/jvmti/scenarios/capability/CM01/cm01t008Thread";
static void JNICALL
...
#ifdef STATIC_BUILD
JNIEXPORT jint JNICALL Agent_OnLoad_cm01t008(JavaVM *jvm, char *options, void *reserved) {
    return Agent_Initialize(jvm, options, reserved);
}
JNIEXPORT jint JNICALL Agent_OnAttach_cm01t008(JavaVM *jvm, char *options, void *reserved) {
    return Agent_Initialize(jvm, options, reserved);
}
JNIEXPORT jint JNI_OnLoad_cm01t008(JavaVM *jvm, char *options, void *reserved) {
