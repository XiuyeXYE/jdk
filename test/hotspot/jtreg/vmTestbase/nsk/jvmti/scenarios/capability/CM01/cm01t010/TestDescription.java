 ...
 * @test
 *
 * @summary converted from VM Testbase nsk/jvmti/scenarios/capability/CM01/cm01t010.
 * VM Testbase keywords: [quick, jpda, jvmti, noras, redefine]
 * VM Testbase readme:
 * DESCRIPTION
 *     The test is for CM01 scenario of "capability management".
 *     This test checks capability can_get_source_file_name
 ...
 *     - replace checked capability can_get_source_info
 *       with one of new capabilities can_get_source_file
 ...
 *      -agentlib:cm01t010=-waittime=5
 *      nsk.jvmti.scenarios.capability.CM01.cm01t010
 */
