 ...
 * @test
 *
 * @summary converted from VM Testbase nsk/jvmti/scenarios/capability/CM01/cm01t007.
 * VM Testbase keywords: [jpda, jvmti, onload_only_caps, noras, redefine]
 * VM Testbase readme:
 * DESCRIPTION
 *     The test is for CM01 scenario of "capability management".
 *     This test checks capability can_pop_frame
 ...
 *      -agentlib:cm01t007=-waittime=5
 *      nsk.jvmti.scenarios.capability.CM01.cm01t007
 */
