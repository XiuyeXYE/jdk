 ...
 * @test
 *
 * @summary converted from VM Testbase nsk/jvmti/scenarios/capability/CM01/cm01t021.
 * VM Testbase keywords: [quick, jpda, jvmti, noras, redefine]
 * VM Testbase readme:
 * DESCRIPTION
 *     The test is for CM01 scenario of "capability management".
 *     This test checks capability can_get_thread_cpu_time
 ...
 *      -agentlib:cm01t021=-waittime=5
 *      nsk.jvmti.scenarios.capability.CM01.cm01t021
 */
