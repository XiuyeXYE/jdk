...
Java_nsk_jvmti_scenarios_sampling_SP04_sp04t001ThreadRunningNative_nativeMethod(JNIEnv* jni,
                                                                                     jobject obj) {
...
Java_nsk_jvmti_scenarios_sampling_SP04_sp04t001ThreadRunningNative_checkReady(JNIEnv* jni,
                                                                                   jobject obj) {
...
JNIEXPORT void JNICALL
Java_nsk_jvmti_scenarios_sampling_SP04_sp04t001ThreadRunningNative_letFinish(JNIEnv* jni,
                                                                                  jobject obj) {
...
#ifdef STATIC_BUILD
JNIEXPORT jint JNICALL Agent_OnLoad_sp04t001(JavaVM *jvm, char *options, void *reserved) {
    return Agent_Initialize(jvm, options, reserved);
}
JNIEXPORT jint JNICALL Agent_OnAttach_sp04t001(JavaVM *jvm, char *options, void *reserved) {
    return Agent_Initialize(jvm, options, reserved);
}
JNIEXPORT jint JNI_OnLoad_sp04t001(JavaVM *jvm, char *options, void *reserved) {
