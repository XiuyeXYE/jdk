...
static jint threadsStatus[THREADS_KINDS] = {
...
agentProc(jvmtiEnv* jvmti, JNIEnv* agentJNI, void* arg) {
    ...
    /* perform testcase(s) */
    {
        ...
        /* resume threads */
        NSK_DISPLAY0("Resume threads individually\n");
...
Java_nsk_jvmti_scenarios_sampling_SP03_sp03t002ThreadRunningNative_nativeMethod(JNIEnv* jni,
                                                                                     jobject obj) {
...
Java_nsk_jvmti_scenarios_sampling_SP03_sp03t002ThreadRunningNative_checkReady(JNIEnv* jni,
                                                                                   jobject obj) {
...
JNIEXPORT void JNICALL
Java_nsk_jvmti_scenarios_sampling_SP03_sp03t002ThreadRunningNative_letFinish(JNIEnv* jni,
                                                                                  jobject obj) {
...
#ifdef STATIC_BUILD
JNIEXPORT jint JNICALL Agent_OnLoad_sp03t002(JavaVM *jvm, char *options, void *reserved) {
    return Agent_Initialize(jvm, options, reserved);
}
JNIEXPORT jint JNICALL Agent_OnAttach_sp03t002(JavaVM *jvm, char *options, void *reserved) {
    return Agent_Initialize(jvm, options, reserved);
}
JNIEXPORT jint JNI_OnLoad_sp03t002(JavaVM *jvm, char *options, void *reserved) {
