...
#define CLASS_NAME "Lnsk/jvmti/scenarios/hotswap/HS302/hs302t012r/MyClass;"
...
#ifdef STATIC_BUILD
JNIEXPORT jint JNICALL Agent_OnLoad_hs302t012(JavaVM *jvm, char *options, void *reserved) {
    return Agent_Initialize(jvm, options, reserved);
}
JNIEXPORT jint JNICALL Agent_OnAttach_hs302t012(JavaVM *jvm, char *options, void *reserved) {
    return Agent_Initialize(jvm, options, reserved);
}
JNIEXPORT jint JNI_OnLoad_hs302t012(JavaVM *jvm, char *options, void *reserved) {
