...
#ifdef STATIC_BUILD
JNIEXPORT jint JNICALL Agent_OnLoad_hs302t008(JavaVM *jvm, char *options, void *reserved) {
    return Agent_Initialize(jvm, options, reserved);
}
JNIEXPORT jint JNICALL Agent_OnAttach_hs302t008(JavaVM *jvm, char *options, void *reserved) {
    return Agent_Initialize(jvm, options, reserved);
}
JNIEXPORT jint JNI_OnLoad_hs302t008(JavaVM *jvm, char *options, void *reserved) {
