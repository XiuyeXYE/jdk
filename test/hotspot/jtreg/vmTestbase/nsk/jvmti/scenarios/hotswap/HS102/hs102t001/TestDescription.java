 ...
 * @test
 *
 * @summary converted from VM Testbase nsk/jvmti/scenarios/hotswap/HS102/hs102t001.
 ...
 *     core class is used by the test. The VM is provoked to work in compiled
 *     mode by a tight loop in the test.
 * COMMENTS
 *
 * @library /vmTestbase
 *          /test/lib
