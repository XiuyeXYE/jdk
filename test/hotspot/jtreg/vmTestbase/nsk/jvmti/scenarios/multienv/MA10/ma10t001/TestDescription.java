 ...
 * @test
 *
 * @summary converted from VM Testbase nsk/jvmti/scenarios/multienv/MA10/ma10t001.
 ...
 *     can_generate_exception_events and set callbacks for Exception
 *     and ExceptionCatch events, but only agent A1 enables the events.
