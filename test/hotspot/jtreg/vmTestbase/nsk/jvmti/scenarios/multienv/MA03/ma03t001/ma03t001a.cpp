...
static int VMInitEventsExpected = 0;
static int VMDeathEventsCount = 0;
static int VMDeathEventsExpected = 0;
...
agentProc(jvmtiEnv* jvmti, JNIEnv* jni, void* arg) {
    ...
    if (ThreadStartEventsCount > 0) {
        NSK_COMPLAIN1("Unexpected thread start events: %d\n",
            ThreadStartEventsCount);
        nsk_jvmti_setFailStatus();
    }
...
#ifdef STATIC_BUILD
JNIEXPORT jint JNICALL Agent_OnLoad_ma03t001a(JavaVM *jvm, char *options, void *reserved) {
    return Agent_Initialize(jvm, options, reserved);
}
JNIEXPORT jint JNICALL Agent_OnAttach_ma03t001a(JavaVM *jvm, char *options, void *reserved) {
    return Agent_Initialize(jvm, options, reserved);
}
JNIEXPORT jint JNI_OnLoad_ma03t001a(JavaVM *jvm, char *options, void *reserved) {
...
#ifdef STATIC_BUILD
Agent_OnUnload_ma03t001a(JavaVM *jvm)
#else
