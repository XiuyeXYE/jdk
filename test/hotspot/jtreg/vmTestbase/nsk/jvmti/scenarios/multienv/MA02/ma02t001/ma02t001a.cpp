...
#ifdef STATIC_BUILD
JNIEXPORT jint JNICALL Agent_OnLoad_ma02t001a(JavaVM *jvm, char *options, void *reserved) {
    return Agent_Initialize(jvm, options, reserved);
}
JNIEXPORT jint JNICALL Agent_OnAttach_ma02t001a(JavaVM *jvm, char *options, void *reserved) {
    return Agent_Initialize(jvm, options, reserved);
}
JNIEXPORT jint JNI_OnLoad_ma02t001a(JavaVM *jvm, char *options, void *reserved) {
...
#ifdef STATIC_BUILD
Agent_OnUnload_ma02t001a(JavaVM *jvm)
#else
Agent_OnUnload(JavaVM *jvm)
#endif
{
    const char* KEY_PHRASE = "Agent_OnUnload() of the 2nd agent";
