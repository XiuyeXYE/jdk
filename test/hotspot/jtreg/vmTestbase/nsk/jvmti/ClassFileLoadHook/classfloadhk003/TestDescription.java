 ...
 * @test
 *
 * @summary converted from VM Testbase nsk/jvmti/ClassFileLoadHook/classfloadhk003.
 ...
 *     bytecode and classloader is received upon loading of tested class.
 ...
 *           is NULL
 *         - classloader reference passed to callback for tested class
 *           is not NULL
 *         - classloader reference passed to callback for tested class
 *           is equal to expected classloader
 *         - original bytecode passed to callback for tested class
 *           is equal to expected one
 *     The debuggee class preliminary loads original bytecode of the
 *     tested class as a byte array into static field and agent gets
 *     this bytecode and then compares it with bytecode received with
 *     tested event.
 ...
 * @library /vmTestbase
 *          /test/lib
 * @build nsk.jvmti.ClassFileLoadHook.classfloadhk003
 *
 ...
 *      -agentlib:classfloadhk003=-waittime=5
 *      nsk.jvmti.ClassFileLoadHook.classfloadhk003
 *      ./bin
 */
