 ...
 * @test
 *
 * @summary converted from VM Testbase nsk/jvmti/AttachOnDemand/attach039.
 ...
 *     Test checks that agent can start new thread (JVMTI RunAgentThread) and agent should receive events
 *     ThreadStart, ThreadEnd for this thread.
 *
 * @library /vmTestbase
 *          /test/lib
