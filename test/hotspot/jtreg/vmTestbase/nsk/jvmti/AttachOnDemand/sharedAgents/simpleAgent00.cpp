 ...
 * just gets JVMTI environment and calls nsk_aod_agentLoaded and nsk_aod_agentFinished
 * from Agent_OnAttach
 */

#ifdef STATIC_BUILD
JNIEXPORT jint JNI_OnLoad_simpleAgent00(JavaVM *jvm, char *options, void *reserved) {
...
#ifdef STATIC_BUILD
Agent_OnAttach_simpleAgent00(JavaVM *vm, char *optionsString, void *reserved)
#else
