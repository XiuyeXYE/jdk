 ...
 * @test
 *
 * @summary converted from VM Testbase nsk/jvmti/GetClassFields/getclfld005.
 ...
 *       - JVMTI_ERROR_NULL_POINTER if fieldCountPtr is null
 *       - JVMTI_ERROR_NULL_POINTER if fieldsPtr is null
 * COMMENTS
 *     Ported from JVMDI.
 *
 * @library /vmTestbase
