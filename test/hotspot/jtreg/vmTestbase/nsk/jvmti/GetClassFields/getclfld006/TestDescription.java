 ...
 * @test
 *
 * @summary converted from VM Testbase nsk/jvmti/GetClassFields/getclfld006.
 * VM Testbase keywords: [quick, jpda, jvmti, noras]
 * VM Testbase readme:
 * DESCRIPTION
 *     The test exercises JVMTI function
 *         GetClassFields(clazz, fieldCountPtr, fieldsPtr).
 *     The test checks if the function returns empty field list
 ...
 * @library /vmTestbase
 *          /test/lib
 * @run main/othervm/native -agentlib:getclfld006 nsk.jvmti.GetClassFields.getclfld006
 */
