...
#ifdef STATIC_BUILD
JNIEXPORT jint JNICALL Agent_OnLoad_redefclass021(JavaVM *jvm, char *options, void *reserved) {
    return Agent_Initialize(jvm, options, reserved);
}
JNIEXPORT jint JNICALL Agent_OnAttach_redefclass021(JavaVM *jvm, char *options, void *reserved) {
    return Agent_Initialize(jvm, options, reserved);
}
JNIEXPORT jint JNI_OnLoad_redefclass021(JavaVM *jvm, char *options, void *reserved) {
...
Java_nsk_jvmti_RedefineClasses_redefclass021_check(JNIEnv *env, jclass cls,
    ...
    if (err == JVMTI_ERROR_MUST_POSSESS_CAPABILITY &&
        ...
        if (err != JVMTI_ERROR_UNSUPPORTED_REDEFINITION_METHOD_DELETED) {
