 ...
 * @test
 *
 * @summary converted from VM Testbase nsk/jvmti/RedefineClasses/redefclass024.
 ...
 *       - JVMTI_ERROR_UNSUPPORTED_REDEFINITION_CLASS_MODIFIERS_CHANGED if
 ...
 * @library /vmTestbase
 *          /test/lib
 * @build nsk.jvmti.RedefineClasses.redefclass024
 *
 * @comment compile newclassXX to bin/newclassXX
 * @run driver nsk.share.ExtraClassesBuilder
 *      newclass
 *
 * @run main/othervm/native -agentlib:redefclass024 nsk.jvmti.RedefineClasses.redefclass024 ./bin
 */
