...
static const char *expHSMethod = "redefclass028HotMethod";
...
JNIEXPORT jboolean JNICALL Java_nsk_jvmti_RedefineClasses_redefclass028_isRedefinitionOccurred
...
JNIEXPORT void JNICALL Java_nsk_jvmti_RedefineClasses_redefclass028_storeClassBytes
...
#ifdef STATIC_BUILD
JNIEXPORT jint JNICALL Agent_OnLoad_redefclass028(JavaVM *jvm, char *options, void *reserved) {
    return Agent_Initialize(jvm, options, reserved);
}
JNIEXPORT jint JNICALL Agent_OnAttach_redefclass028(JavaVM *jvm, char *options, void *reserved) {
    return Agent_Initialize(jvm, options, reserved);
}
JNIEXPORT jint JNI_OnLoad_redefclass028(JavaVM *jvm, char *options, void *reserved) {
