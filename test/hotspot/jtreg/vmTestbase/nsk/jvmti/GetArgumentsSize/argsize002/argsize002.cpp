...
#ifdef STATIC_BUILD
JNIEXPORT jint JNICALL Agent_OnLoad_argsize002(JavaVM *jvm, char *options, void *reserved) {
    return Agent_Initialize(jvm, options, reserved);
}
JNIEXPORT jint JNICALL Agent_OnAttach_argsize002(JavaVM *jvm, char *options, void *reserved) {
    return Agent_Initialize(jvm, options, reserved);
}
JNIEXPORT jint JNI_OnLoad_argsize002(JavaVM *jvm, char *options, void *reserved) {
...
Java_nsk_jvmti_GetArgumentsSize_argsize002_check(JNIEnv *env, jclass cls) {
    jvmtiError err;
    jmethodID mid;
    jint size;
    ...
    err = jvmti->GetArgumentsSize(mid, &size);
