 ...
 * @test
 *
 * @summary converted from VM Testbase nsk/jvmti/IterateOverObjectsReachableFromObject/iterobjreachobj001.
 * VM Testbase keywords: [quick, jpda, jvmti, noras]
 * VM Testbase readme:
 * DESCRIPTION
 *     This JVMTI test exercises JVMTI heap function IterateOverObjectsReachableFromObject().
 *     This tests checks that IterateOverObjectsReachableFromObject() function
 ...
 *     Also the test checks that IterateOverObjectsReachableFromObject() passes
 *     correct values to the callback.
