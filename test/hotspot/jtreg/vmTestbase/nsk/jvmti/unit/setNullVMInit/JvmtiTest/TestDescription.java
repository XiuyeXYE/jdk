 ...
 * @test
 *
 * @summary converted from VM Testbase nsk/jvmti/unit/setNullVMInit/JvmtiTest.
 ...
 * @library /vmTestbase
 *          /test/lib
 * @run main/othervm/native -agentlib:setNullVMInit=-waittime=5 nsk.jvmti.unit.setNullVMInit.JvmtiTest
 */
