 ...
 * @test
 *
 * @summary converted from VM Testbase nsk/jvmti/unit/heap/ObjectSizeTests.
 ...
 * COMMENTS
 *    Fixed CR 6708236: Added fields for the test to work with CompressedOops
 *
 * @library /vmTestbase
 *          /test/lib
 * @run main/othervm/native -agentlib:Heap=-waittime=5 nsk.jvmti.unit.heap.ObjectSizeTests
 */
