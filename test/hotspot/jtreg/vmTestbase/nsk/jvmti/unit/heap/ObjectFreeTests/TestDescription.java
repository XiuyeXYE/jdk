 ...
 * @test
 *
 * @summary converted from VM Testbase nsk/jvmti/unit/heap/ObjectFreeTests.
 ...
 * @library /vmTestbase
 *          /test/lib
 * @run main/othervm/native -agentlib:Heap=-waittime=5 nsk.jvmti.unit.heap.ObjectFreeTests
 */
