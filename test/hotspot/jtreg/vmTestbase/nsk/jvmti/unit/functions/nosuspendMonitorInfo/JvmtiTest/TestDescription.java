 ...
 * @test
 *
 * @summary converted from VM Testbase nsk/jvmti/unit/functions/nosuspendMonitorInfo/JvmtiTest.
 * VM Testbase keywords: [quick, jpda, jvmti, onload_only_caps, noras]
 * VM Testbase readme:
 * DESCRIPTION
 *     The test exercise GetMonitorInfo and GetContendedMonitor
 *     threads are not suspended case.
 * COMMENTS
