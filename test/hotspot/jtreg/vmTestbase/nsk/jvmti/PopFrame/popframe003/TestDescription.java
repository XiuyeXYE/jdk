 ...
 * @test
 *
 * @summary converted from VM Testbase nsk/jvmti/PopFrame/popframe003.
 ...
 *     function PopFrame():
 *        - the method arguments will be added back and any changes to
 *          the arguments, which occurred in the called method, will remain;
 *        - changes to global state, which occurred in the called method,
 *          will remain;
 ...
 * @library /vmTestbase
 *          /test/lib
 * @run main/othervm/native -agentlib:popframe003 nsk.jvmti.PopFrame.popframe003
 */
