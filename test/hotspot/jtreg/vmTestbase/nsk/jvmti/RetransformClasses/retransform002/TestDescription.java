 ...
 * @test
 *
 * @summary converted from VM Testbase nsk/jvmti/RetransformClasses/retransform002.
 * VM Testbase keywords: [quick, jpda, jvmti, noras, redefine, feature_jdk6_jpda, vm6]
 * VM Testbase readme:
 * DESCRIPTION
 * This test ensures that retransformation of unmodifiable classes(arrays, primitive types)
 * is not allowed.
 * COMMENTS
 *
 * @library /vmTestbase
