...
#ifdef STATIC_BUILD
JNIEXPORT jint JNICALL Agent_OnLoad_stopthrd006(JavaVM *jvm, char *options, void *reserved) {
    return Agent_Initialize(jvm, options, reserved);
}
JNIEXPORT jint JNICALL Agent_OnAttach_stopthrd006(JavaVM *jvm, char *options, void *reserved) {
    return Agent_Initialize(jvm, options, reserved);
}
JNIEXPORT jint JNI_OnLoad_stopthrd006(JavaVM *jvm, char *options, void *reserved) {
...
Java_nsk_jvmti_StopThread_stopthrd006_check(JNIEnv *env,
        jclass cls, jthread thr, jobject ex) {
    jvmtiError err;
