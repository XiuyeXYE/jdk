 ...
 * @test
 *
 * @summary converted from VM Testbase nsk/jvmti/GetSourceFileName/getsrcfn004.
 ...
 *       - JVMTI_ERROR_NULL_POINTER if sourceNamePtr is null
 * COMMENTS
 *     Ported from JVMDI.
 ...
 * @library /vmTestbase
 *          /test/lib
 * @run main/othervm/native -agentlib:getsrcfn004 nsk.jvmti.GetSourceFileName.getsrcfn004
 */
