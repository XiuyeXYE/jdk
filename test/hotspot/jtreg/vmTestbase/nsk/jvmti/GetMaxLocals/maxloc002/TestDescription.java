 ...
 * @test
 *
 * @summary converted from VM Testbase nsk/jvmti/GetMaxLocals/maxloc002.
 * VM Testbase keywords: [quick, jpda, jvmti, noras]
 * VM Testbase readme:
 * DESCRIPTION
 *     The test exercises JVMTI function GetMaxLocals(method, maxPtr).
 *     The test checks if the function returns:
 *       - JVMTI_ERROR_INVALID_METHODID if method is null
 *       - JVMTI_ERROR_NULL_POINTER if maxPtr is null
