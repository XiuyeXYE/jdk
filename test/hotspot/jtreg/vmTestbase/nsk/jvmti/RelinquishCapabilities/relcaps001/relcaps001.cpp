...
#ifdef STATIC_BUILD
JNIEXPORT jint JNICALL Agent_OnLoad_relcaps001(JavaVM *jvm, char *options, void *reserved) {
    return Agent_Initialize(jvm, options, reserved);
}
JNIEXPORT jint JNICALL Agent_OnAttach_relcaps001(JavaVM *jvm, char *options, void *reserved) {
    return Agent_Initialize(jvm, options, reserved);
}
JNIEXPORT jint JNI_OnLoad_relcaps001(JavaVM *jvm, char *options, void *reserved) {
...
jint Agent_Initialize(JavaVM *jvm, char *options, void *reserved) {
    ...
    NSK_DISPLAY0(">>> Testcase #0: Remove all potential capabilities in Agent_OnLoad()\n");
    if (!removeCapabilities(jvmti, &initCaps, "Agent_OnLoad()")) {
        nsk_jvmti_setFailStatus();
    }
