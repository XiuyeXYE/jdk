 ...
 * @test
 *
 * @summary converted from VM Testbase nsk/jvmti/RelinquishCapabilities/relcaps002.
 * VM Testbase keywords: [quick, jpda, jvmti, noras]
 * VM Testbase readme:
 * DESCRIPTION
 *     This JVMTI test exercises JVMTI thread function RelinquishCapabilities().
 *     This test checks that RelinquishCapabilities() in live phase removes
 *     all potentially available capabilities added by AddCapabilities
 *     in Agent_OnLoad(). This is checked by GetCapabilities() in live phases.
