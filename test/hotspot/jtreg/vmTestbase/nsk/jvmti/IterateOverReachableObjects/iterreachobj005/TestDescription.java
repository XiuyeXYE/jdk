 ...
 * @test
 *
 * @summary converted from VM Testbase nsk/jvmti/IterateOverReachableObjects/iterreachobj005.
 ...
 *        GetTimerInfo
 *        GetTime
 *     may be called in the callbacks of IterateOverReachableObjects
 ...
 *        ObjectFree events.
 *     The test defines jvmtiHeapRootCallback, jvmtiStackReferenceCallback
 *     jvmtiObjectReferenceCallback callbacks which invokes the checked
 *     timer functions and performs basic sanity checks of returned results.
 *     Then IterateOverReachableObjects function is invoked with the
 *     defined callbacks.
 * COMMENTS
