...
GarbageCollectionFinish(jvmtiEnv *jvmti_env) {
    ...
    rawMonitorFunc(jvmti_env, "GarbageCollectionFinish");

    memoryFunc(jvmti_env, "GarbageCollectionFinish");
...
#ifdef STATIC_BUILD
JNIEXPORT jint JNICALL Agent_OnLoad_gcfinish001(JavaVM *jvm, char *options, void *reserved) {
    return Agent_Initialize(jvm, options, reserved);
}
JNIEXPORT jint JNICALL Agent_OnAttach_gcfinish001(JavaVM *jvm, char *options, void *reserved) {
    return Agent_Initialize(jvm, options, reserved);
}
JNIEXPORT jint JNI_OnLoad_gcfinish001(JavaVM *jvm, char *options, void *reserved) {
