...
#ifdef STATIC_BUILD
JNIEXPORT jint JNICALL Agent_OnLoad_setfldw002(JavaVM *jvm, char *options, void *reserved) {
    return Agent_Initialize(jvm, options, reserved);
}
JNIEXPORT jint JNICALL Agent_OnAttach_setfldw002(JavaVM *jvm, char *options, void *reserved) {
    return Agent_Initialize(jvm, options, reserved);
}
JNIEXPORT jint JNI_OnLoad_setfldw002(JavaVM *jvm, char *options, void *reserved) {
...
Java_nsk_jvmti_SetFieldAccessWatch_setfldw002_check(JNIEnv *env, jclass cls) {
    jvmtiError err;
    jfieldID fid;
