 ...
 * @key stress
 *
 * @summary converted from VM Testbase gc/memory/UniThread/Circular2.
...
package gc.memory.UniThread.Circular2;

import nsk.share.gc.*;
import gc.memory.UniThread.Circular1.Circular1;
...
public class Circular2 {
        public static void main(String args[]) {
                ...
                GC.runTest(new Circular1(objectSize, circularitySize), args);
        }
}
